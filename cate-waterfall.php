...
<div class="container waterfall">
	<div class="row">
		<div class="col-md-9">
			...
			<div id="posts">
			<?php $posts =  query_posts($query_string .'&ignore_sticky_posts=1&orderby=date&showposts=14');?>       
			<?php if( $posts ) : ?>                                      
			...
			<div id="post-<?php the_ID() ?>" class="onepost col-md-4 col-xs-12">
				...
				<div class="thumb">
					...
					<img data-original="<?php post_thumbnail_src_2();?>"  alt='<?php the_title(); ?>' class="lazy img-responsive img-rounded">
